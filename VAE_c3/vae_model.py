...
#         self.fc21 = nn.Linear(256, latent_dim)  # Latent space mean (mu)
#         self.fc22 = nn.Linear(256, latent_dim)  # Latent space log variance (logvar)
#
...
#
#     def reparammeterize(self, mu, logvar):
...
#
#         # Create a prior distribution (e.g., standard normal)
